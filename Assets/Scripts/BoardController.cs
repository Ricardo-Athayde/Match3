...
namespace Bejeweled
{
    public class BoardController : MonoBehaviour
    {
        ...
        [HideInInspector]
        public UnityEvent<Int2> onPieceRemoved; //Invoked whenever a piece moved from one place to another (Ex: dropping)
        #endregion
        ...
        void Start()
        {
            curBoard = new int[boardSettings.boardWidth, boardSettings.boardHeight];
            CreateBoard();
        }
        ...
        { 
            ...
            while (keepCheckingMatches) //Loops until no matches are found on the board
            {
                ...
                else
                {
                    ...
                    ScoreController.instance.AddScore(removedPiecesCount,comboCount);
